...
app.get('/signUpAsVolunteer',signUp.goToSignUpVolunteerPage);
app.get('/signUpAsNPO',signUp.goToSignUpNPOPage);
app.post('/signUpAsVolunteer',signUp.afterSignUpAsVolunteer);
app.post('/signUpAsNPO',signUp.afterSignUpAsNPO);
